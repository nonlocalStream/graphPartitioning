...
*)
	...
	Options[MultipleFiedlerVector]={Range->{1/5,4/5}}
	MultipleFiedlerVector[g_Graph,OptionsPattern[]] := Maximum[
...
(*			If[Norm[n]>Norm[bestn], bestn=n;bestPartition=partition, Nothing];
			Print["count:",count];
			Print[Norm[n]];
		    Print[Norm[bestn]];*)
