...
*)
	...
	MultipleFiedlerEdges[g_Graph, OptionsPattern[]] := With[{v=MultipleFiedlerVector[g], cutoff=0.5},
		If[OptionValue[IncludeObj],
			{CriterionPartitionFunction[g,v,cutoff], VectorCut[g, v, cutoff]},
			VectorCut[g, v, 0.5]]]

	MultipleFiedlerCut[g_Graph] := ChangeEdges[g, Complement[Edges[g], MultipleFiedlerEdges[g]]]
	...
	Options[MultipleFiedlerVector]={Range->{1/5,4/5}, NumEigen->5}
	MultipleFiedlerVector[g_Graph,OptionsPattern[]] :=
		VectorPartition[SpectralVectors[g,OptionValue[NumEigen]], V[g], OptimizationOn->True,
