...
(*With[{edge=GraphOptions[g,e]},
	...
	CriterionCut[g_Graph,vector_List,OptionsPattern[]] :=
		...
		GeneralizedCriterionCut[CriterionFunction,g,vector,range,IncludeCut->OptionValue[IncludeCut]]]

	CriterionFunction[g_Graph,v_List,c_] := With[{partitionWeights=PartitionWeights[VertexWeights[g],v,c]},
