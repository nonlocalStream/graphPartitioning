...
*)
	...
	MultipleFiedlerEdges[g_Graph] := VectorCut[g, MultipleFiedlerVector[g], 0.5]
	MultipleFiedlerCut[g_Graph] := ChangeEdges[g, Complement[Edges[g], MultipleFiedlerEdges[g]]]
		
(*	MultipleFiedlerEdges[g_Graph] := With[{v=IsoperimetricVector[g,
			Substitutions->Sort[Map[ #[[Random[Integer,{1,Length[#]}]]]&, ConnectedComponents[g]]],IsoperimetricMode->If[OptionValue[RunTwice],Twice,Fixed]]},
		VectorCut[g,v,CriterionCut[g,v]]]*)
...
*)
	...
	ShowMultipleFiedlerCut[g_Graph] := ShowGraph[Highlight[g,{MultipleFiedlerEdges[g]},
			HighlightedEdgeColors->{Red},
			HighlightedEdgeStyle->Dashed]]
